    ...
    <Link href={"/anime/" + anime.id} className="h-full w-full">
      <div className="group/epCard st-anime-card h-full">
        ...
        <div className="st-anime-card-detail relative overflow-hidden group-hover/epCard:min-h-[50%] ">
          ...
          <p dangerouslySetInnerHTML={{ __html: anime.description }} className="no-scrollbar h-0 overflow-hidden font-normal transition-all group-hover/epCard:h-[150px] flex flex-wrap hyphens-auto whitespace-nowrap items-center group-hover/epCard:overflow-y-scroll">
          </p>
        </div>
      </div>
    </Link>
